// app/courses/[slug]/learn/error.tsx
"use client";
    ...
    <div className="flex justify-center mt-16 px-4">
      <div className="max-w-md w-full bg-white rounded p-8 text-center border border-gray-100 shadow-sm">
        ...
        <p className="text-gray-500 mb-6">
          {error?.message ||
            "We encountered a problem loading the course content. This might be a connection issue or the course may not be available."}
        </p>
